...
public class NewAdminCreationPage extends BasePage {

	public NewAdminCreationPage(WebDriver driver) {
		super(driver);
	}
	...
	public void newCustomerLogin(String mobileNo) {
	...
	public Boolean newCmpyCreation() {
		try {
			get_EnterName().clear();
			get_EnterName().sendKeys("Anandh");
			get_CmpName().clear();
